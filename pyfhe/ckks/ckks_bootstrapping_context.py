...
from pyfhe.util.ciphertext import Ciphertext
import pyfhe.util.matrix_operations
from pyfhe.util.polynomial import Polynomial
from pyfhe.util.random_sample import sample_triangle
...
class CKKSBootstrappingContext:
    ...
    def generate_encoding_matrices(self):
        ...
        self.encoding_mat_transpose0 = pyfhe.util.matrix_operations.transpose_matrix(self.encoding_mat0)
        self.encoding_mat_conj_transpose0 = pyfhe.util.matrix_operations.conjugate_matrix(
            self.encoding_mat_transpose0)
        self.encoding_mat_transpose1 = pyfhe.util.matrix_operations.transpose_matrix(self.encoding_mat1)
        self.encoding_mat_conj_transpose1 = pyfhe.util.matrix_operations.conjugate_matrix(
